...
/**
 * Positional (shaped) counterpart of {@link AlterShapelessRecipe} for the Alter's
 * 3x3 grid (slots 0-8) plus catalyst slot 9. Pattern/key parsing follows the
 * vanilla shaped-recipe JSON format.
 */
public class AlterShapedRecipe implements AltarRecipe {
    ...
    public AlterShapedRecipe(ResourceLocation id, int width, int height, NonNullList<Ingredient> ingredients,
    ...
    @Override public RecipeSerializer<?> getSerializer() { return ModRecipeSerializers.ALTER_SHAPED.get(); }
    @Override public RecipeType<?> getType() { return ModRecipeSerializers.ALTER_SHAPED_TYPE.get(); }
    ...
    public static class Serializer implements RecipeSerializer<AlterShapedRecipe> {
        @Override
        public AlterShapedRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new AlterShapedRecipe(id, width, height, ings, out, catalyst, time, fuel, adv);
        }

        @Override
        public AlterShapedRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new AlterShapedRecipe(id, width, height, ings, out, cat, time, fuel, adv);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buf, AlterShapedRecipe recipe) {
