package net.onixary.shapeShifterCurseForge.menu;
...
public class AlterMenu extends AbstractContainerMenu {
    ...
    public AlterMenu(int id, Inventory inv, Container container, ContainerData data) {
        super(ModMenuTypes.ALTER.get(), id);
