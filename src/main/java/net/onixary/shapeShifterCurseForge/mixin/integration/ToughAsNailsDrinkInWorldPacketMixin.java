...
@Mixin(targets = "toughasnails.network.DrinkInWorldPacket", remap = false)
@Pseudo
public abstract class ToughAsNailsDrinkInWorldPacketMixin {
    ...
    private static boolean ssc$preventHandDrinkEffect(Player player, MobEffectInstance effect) {
