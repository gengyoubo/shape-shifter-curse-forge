...
public abstract class CurioImpl implements ICurioItem {
    ...
    @Unique
    private static net.minecraft.resources.ResourceLocation shape_shifter_curse_forge$toSlotId(SlotContext ctx) {
    ...
    public void curioTick(SlotContext slotContext, ItemStack stack) {
        ...
        self.accessoryTick(stack, slotContext.entity(),
                new AccessoryItem.SlotData(shape_shifter_curse_forge$toSlotId(slotContext), slotContext.index()));
    }
